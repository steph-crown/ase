...
export function InstallSection() {
  return (
    <section id="install" className="py-16 sm:py-24 sm:pt-10 bg-background">
      <div className="wrapper">
        <div className="text-center mb-10 sm:mb-14">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-medium text-foreground leading-[106%] font-air tracking-[-2%] mb-3 sm:mb-4 ">
